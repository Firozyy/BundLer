...
import { login, register ,logout, getmyprofile, changepassword, updateProfile, updateprfilepicture, forgotpassword,  resetPassword, addtoplaylist, removeFromplaylistt, getallUsers, updateUsrRole, deletprofile, deletmyprofile, phoneLogin, otpVerification} from "../controlers/userControler.js";
...
router.route('/login/phone').post(phoneLogin)
router.route('/otpverification/:phoneNumber').post(otpVerification)
